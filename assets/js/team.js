...
const clubHeads = [
    ...
    {
        imgSrc: "../media/members/Hemant_Srivastava.jpg",
    ...
    {
        imgSrc: "../media/members/Krishna Singhal.jpg",
...
const coreTeam = [
    {
        imgSrc: "../media/members/Kumari_Kriti_Singh.jpg",
    ...
    {
        imgSrc: "../media/members/Aditya_Raj.jpg",
        name: "Aditya Raj",
    ...
    {
        imgSrc: "../media/members/Aalok Kumar Yadav.jpg",
    ...
    {
        imgSrc: "../media/members/mohitgoyal.jpg",
        name: "Mohit goyal",
    ...
    {
        imgSrc: "../media/members/Agrim Sing.jpg",
        name: "Agrim Singh",
    ...
    {
        imgSrc: "../media/members/Chandan_Yadav.jpg",
        name: "Chandan yadav",
    ...
    {
        imgSrc: "../media/members/Yukta.jpg",
        name: "Yukta shree",
    ...
    {
        imgSrc: "../media/members/Peshal_mishra.jpg",
        name: "Peshal Mishra",
    ...
    {
        imgSrc: "../media/members/Aman_Singh.jpg",
        name: "Aman Singh",
    ...
    {
        imgSrc: "../media/members/Barla jaswanth.jpg",
        name: "Barla Jaswanth",
    ...
    {
        imgSrc: "../media/members/kalpana_negiwal.jpg",
    ...
    {
        imgSrc: "../media/members/Aman_kumar.jpg",
        name: "Aman Kumar",
